...
namespace Entidades
{
    public partial class DevCodeTrucoApp_dbContext : DbContext
    {
        public DevCodeTrucoApp_dbContext()
        {
        }

        public DevCodeTrucoApp_dbContext(DbContextOptions<DevCodeTrucoApp_dbContext> options)
            : base(options)
        {
        }
