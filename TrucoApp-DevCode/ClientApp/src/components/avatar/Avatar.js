				...
				<div className="componente-cambio-aspecto">
					...
					<div className="modificar color-pelo">
						<div className="pelo pelo-negro"
							title="pelo negro"
							onClick={() => setPelo(pelo, "ceja-negra")}></div>
						<div className="pelo pelo-castano"
							title="pelo castaño"
							onClick={() => setPelo(peloCastano, "ceja-castana")}></div>
						<div className="pelo pelo-rubio"
							title="pelo rubio"
							onClick={() => setPelo(peloRubio, "ceja-rubia")}></div>
						<div className="pelo pelo-colorado"
							title="pelo colorado"
							onClick={() => setPelo(peloColorado, "ceja-colorada")}></div>
						<div className="pelo pelo-canoso"
							title="pelo canoso"
							onClick={() => setPelo(peloCanoso, "ceja-canosa")}></div>
					</div>
				</div>
			</div>
		</div>
