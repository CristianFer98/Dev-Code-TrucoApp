            ...
            <Card style={{ width: "15rem", height: "125px", margin: "10px" }}>
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  Organiza: Roberto123{" "}
                  <Card.Img
                    src="https://robohash.org/user3.png"
                    style={{ width: "40px", height: "40px" }}
                  ></Card.Img>
                </Card.Subtitle>
                <Card.Link href="#">Acceder al Torneo</Card.Link>
            ...
            <Card style={{ width: "15rem", height: "125px", margin: "10px" }}>
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  Organiza: Marian89{" "}
                  <Card.Img
                    src="https://robohash.org/user4.png"
                    style={{ width: "40px", height: "40px" }}
                  ></Card.Img>
                </Card.Subtitle>
                <Card.Link href="#">Acceder al Torneo</Card.Link>
            ...
            <Card style={{ width: "15rem", height: "125px", margin: "10px" }}>
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  Organiza: RoboHHH{" "}
                  <Card.Img
                    src="https://robohash.org/user5.png"
                    style={{ width: "40px", height: "40px" }}
                  ></Card.Img>
                </Card.Subtitle>
                <Card.Link href="#">Acceder al Torneo</Card.Link>
            ...
            <Card style={{ width: "15rem", height: "125px", margin: "10px" }}>
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  Organiza: Dabydenko{" "}
                  <Card.Img
                    src="https://robohash.org/user6.png"
                    style={{ width: "40px", height: "40px" }}
                  ></Card.Img>
                </Card.Subtitle>
                <Card.Link href="#">Acceder al Torneo</Card.Link>
            ...
            <Card style={{ width: "15rem", height: "125px", margin: "10px" }}>
              <Card.Body>
                ...
                <Card.Subtitle className="mb-2 text-muted">
                  Organiza: HyperDrup{" "}
                  <Card.Img
                    src="https://robohash.org/user7.png"
                    style={{ width: "40px", height: "40px" }}
                  ></Card.Img>
                </Card.Subtitle>
                <Card.Link href="#">Acceder al Torneo</Card.Link>
